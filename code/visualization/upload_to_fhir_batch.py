...
# load data
data = pd.read_csv('/Users/winniez/Desktop/Gatech/Gatech_OMSCS/CS6440/Group_project/CS6440-Project/kaggle_data/visulization/diabetic_data_filtered.csv')
...
def create_observation_resources(row):
    ...
    for diag_col in diag_columns:
        ...
        if pd.notna(concept_code):
            ...
            coding.display = str(concept_name)  # Concept Name as display value
    ...
    if pd.notna(glucose_value):
        ...
        if glucose_value_display == ">300":
            ...
            # Create Coding and CodeableConcept for interpretation
            critical_high_coding = Coding()
            critical_high_coding.system = "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation"
            critical_high_coding.code = "HH"
            critical_high_coding.display = "Critical high"
            
            critical_high_interpretation = CodeableConcept()
            critical_high_interpretation.coding = [critical_high_coding]
            
            glucose_observation.interpretation = [critical_high_interpretation]
            ...
            # Create Coding and CodeableConcept for interpretation
            sig_high_coding = Coding()
            sig_high_coding.system = "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation"
            sig_high_coding.code = "HU"
            sig_high_coding.display = "Significantly high"
            
            sig_high_interpretation = CodeableConcept()
            sig_high_interpretation.coding = [sig_high_coding]
            
            glucose_observation.interpretation = [sig_high_interpretation]
            ...
            # Create normal interpretation
            normal_coding = Coding()
            normal_coding.system = "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation"
            normal_coding.code = "N"
            normal_coding.display = "Normal"
            
            normal_interpretation = CodeableConcept()
            normal_interpretation.coding = [normal_coding]
            
            glucose_observation.interpretation = [normal_interpretation]
            # glucose_observation.interpretation = [CodeableConcept({
            #     'coding': [Coding({
            #         'system': "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation",
            #         'code': "N",  # Normal
