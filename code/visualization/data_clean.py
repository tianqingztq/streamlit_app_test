...
def clean_weight(dataframe):
    ...
    for weight in dataframe['weight']:
        if weight == '[0-25)':
            ...
            cleaned_weights.append({'value': {'low': pounds_to_kg(200), 'high': 99999999}, 'unit': 'kg'})
        elif weight == '?':
...
# data filter 
# data = pd.read_csv('/Users/winniez/Desktop/Gatech/Gatech_OMSCS/CS6440/Group_project/CS6440-Project/kaggle_data/visulization/diabetic_data.csv')

# # Apply the filters
# filtered_data = data[
#     data['race'].notna() &
#     data['gender'].notna() &
#     ~((data['max_glu_serum'].isna()) & (data['A1Cresult'].isna()))
# ]
...
# filtered_data.to_csv('/Users/winniez/Desktop/Gatech/Gatech_OMSCS/CS6440/Group_project/CS6440-Project/kaggle_data/visulization/diabetic_data_filtered_2.csv', index=False)
